...
# How to Send and Receive UDP Packets
...
[^udp_better]: Instances when the needs of the game are not aligned with the points mentioned in the introduction may use TCP instead. Many notable games, such as StarCraft, Guild Wars (and many other MMOs) use TCP exclusively.
